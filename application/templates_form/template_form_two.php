    ...
    '<!DOCTYPE html>
        ...
        <body>
            <div class="Section1">
                ...
                <tbody>
                <tr>
                    <td rowspan="2" width="48" attr="' .$today . '" >
                        Дата инструктажа
                    </td>
...
if(!is_dir($folder_name)){
    ...
    file_put_contents($folder_name.'/real_form_two.doc', $result_file, FILE_APPEND);
    $doc_download_url = 'application/real_forms/'.md5($result_file).'/real_form_two.doc';
    $file_name = "real_form_two.doc";
