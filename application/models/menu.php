    ...
    public function login_buttons(){
        ...
        if(isset($_SESSION['user_id'])){
            ...
            if($_SESSION['role_id'] == 1){
                ...
                $login_buttons .= '<a href="/period_control" class="attr"name="Периодичность инструктажей"><img src="../../templates/simple_template/images/company_docs.svg"><div class="display_none">Документы компании</div></a>';
