        ...
        foreach ($pSheet->getDrawingCollection() as $drawing) {
            if ($drawing instanceof PHPExcel_Worksheet_Drawing) {
                if ($drawing->getCoordinates() == $coordinates) {
                    ...
                    $html .= '<img_del style="position: absolute; z-index: 1; left: ' .
                ...
                $html .= '<img_del src="'.$dataUri.'" style="max-width:100%;width:'.$drawing->getWidth().'px;" />';
            }
        }
            ...
            if ($chart instanceof PHPExcel_Chart) {
                ...
                if ($chartCoordinates['cell'] == $coordinates) {
                    ...
                    if ($fp = fopen($chartFileName, "rb", 0)) {
                        ...
                        $html .= '<div style="position: relative;">';
                        $html .= '<img_del style="position: absolute; z-index: 1; left: ' . $chartCoordinates['xOffset'] . 'px; top: ' . $chartCoordinates['yOffset'] . 'px; width: ' . $imageDetails[0] . 'px; height: ' . $imageDetails[1] . 'px;" src="' . $imageData . '" border="0" />' . PHP_EOL;
                        $html .= '</div>';
